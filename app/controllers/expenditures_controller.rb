class ExpendituresController < ApplicationController
  ...
  private
    ...
    def expenditure_params
      params.require(:expenditure).permit(:report_id, :entity_id, :transaction_id, :payment_method_id, :travel_id, :candidate_id, :expen_category_id, :expend_type_id, :date, :amount, :purpose, :expendituretotal)
    end
end

class TravelsController < ApplicationController
  ...
  private
    ...
    def travel_params
      params.require(:travel).permit(:report_id, :entity_id, :candidate_id, :travel_schedule_id, :purpose, :travelbegin, :travelend, :transportation, :departureloc, :destinationloc)
    end
end
